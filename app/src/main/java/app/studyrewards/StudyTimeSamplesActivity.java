...
public class StudyTimeSamplesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentTask = intent.getStringExtra("task");

        final StudyManagement management = (StudyManagement) getApplicationContext();

        Log.d(TAG,"storage :" + management.toString());

        setContentView(R.layout.activity_study_timer_samples);

        lblTaskTitle = findViewById(R.id.lblTaskTitle);
        String screenTitle = lblTaskTitle.getText().toString() + " " + currentTask;
        ...
        btnGetTime = findViewById(R.id.btnPause);
        ...
        btnGetProgress = findViewById(R.id.btnEndSession);
